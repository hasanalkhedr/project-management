                ...
                <td class="content-cell" colspan="2">
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="text-align: center;">التاريخ: {{ $record->start_date ? (is_string($record->start_date) ? $record->start_date : $record->start_date->format('d/m/Y')) : 'غير محدد' }}</td>
                            <td style="text-align: left;">اليوم: {{ $record->start_date ? (is_string($record->start_date) ? \Carbon\Carbon::parse($record->start_date)->locale('ar')->dayName : $record->start_date->locale('ar')->dayName) : 'غير محدد' }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
