            ...
            <table class="meta-table">
                <tr>
                    ...
                    <td class="meta-left">
                        ...
                        <span class="value-text">{{ $record->contract_date ? $record->contract_date->format('d/m/Y') : 'غير محدد' }}</span>
                    </td>
                    <td class="meta-divider">|</td>
                    <td class="meta-left">
                        <span class="value-text">{{ $record->contract_date ? $record->contract_date->locale('ar')->dayName : 'غير محدد' }}</span>
                    </td>
                </tr>
            </table>
        </div>
